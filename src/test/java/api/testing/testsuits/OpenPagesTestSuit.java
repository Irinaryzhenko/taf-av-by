...
public class OpenPagesTestSuit {
    ...
    public void checkStatusCodeHomePage() {
        when().get("https://av.by/").then().log().status()
    ...
    public void checkStatusCodeCarPage() {
        when().get("https://cars.av.by/").then().log().status()
                .assertThat().statusCode(200);
    }
    ...
    public void checkStatusCodeWheelsPartsPage() {
        when().get("https://parts.av.by/").then().log().status()
                .assertThat().statusCode(200);
    }
    ...
    public void checkStatusCodeNewsPage() {
        when().get("https://av.by/news").then().log().status()
                .assertThat().statusCode(200);
    }
    ...
    public void checkStatusCodeInfoPage() {
        when().get("https://av.by/pages/info").then().log().status()
                .assertThat().statusCode(200);
    }
    ...
    public void checkStatusCodeFinancePage() {
        when().get("https://av.by/finance").then().log().status()
                .assertThat().statusCode(200);
    }
    ...
    public void checkStatusCodeVinCheckerPage() {
        when().get("https://av.by/vin").then().log().status()
                .assertThat().statusCode(200);
    }
    ...
    public void checkHomePageContentType() {
        when().get("https://av.by/").then().log().headers()
